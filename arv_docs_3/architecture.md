...
## 0. Documentation Topology (2026-04 Refresh)
...
- Design split docs:
  ...
  - `docs/design/world-generation-and-poi-streaming-and-geometry.md`
  - `docs/design/world-generation-and-poi-navigation-and-ai-coupling.md`
...
- Module split docs:
  ...
  - `docs/modules/rv-chassis-energy-energy-loop.md`
  - `docs/modules/rv-chassis-energy-drive-control-and-durability.md`
  - `docs/modules/world-generation-streaming-and-geometry.md`
  - `docs/modules/world-generation-poi-and-navigation.md`
- No `docs/knowledge/*.md` files were added in this refresh because no external reference-source documentation was needed.
...
- Component split map
  - Player partition:
    - Inventory/input contracts -> docs/design/player-interaction-and-equipment-inventory-and-input.md and docs/modules/player-equipment-interactions-inventory-and-input.md
    - Placement/crafting contracts -> docs/design/player-interaction-and-equipment-placement-and-crafting.md and docs/modules/player-equipment-interactions-placement-and-crafting.md
  - RV partition:
    - Energy loop contracts -> docs/design/rv-energy-and-driving-energy-loop.md and docs/modules/rv-chassis-energy-energy-loop.md
    - Drive/damage/wheel contracts -> docs/design/rv-energy-and-driving-drive-control-and-durability.md and docs/modules/rv-chassis-energy-drive-control-and-durability.md
  - World partition:
    - Streaming/geometry contracts -> docs/design/world-generation-and-poi-streaming-and-geometry.md and docs/modules/world-generation-streaming-and-geometry.md
    - POI/navigation contracts -> docs/design/world-generation-and-poi-navigation-and-ai-coupling.md and docs/modules/world-generation-poi-and-navigation.md
- Coverage decisions
