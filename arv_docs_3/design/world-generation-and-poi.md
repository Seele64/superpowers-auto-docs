...
Coverage map:
- Streaming thresholds, transform chaining, terrain/road geometry, and POI footprint terrain blending are documented in the streaming/geometry split doc.
- Navigation-region output, monster navigation coupling, fallback steering, and stuck-recovery coupling are documented in the navigation/AI split doc.
