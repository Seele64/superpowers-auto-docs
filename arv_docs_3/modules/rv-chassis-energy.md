...
This parent module doc remains the high-level boundary and integration map. Detailed contracts are expanded into:

- `docs/modules/rv-chassis-energy-energy-loop.md`
- `docs/modules/rv-chassis-energy-drive-control-and-durability.md`

Coverage map:
- Fuel/power mutation and generator dispatch semantics are documented in the energy-contracts split doc.
- Driving/refuel control authority, durability, and wheel-slot contracts are documented in the control/damage split doc.
